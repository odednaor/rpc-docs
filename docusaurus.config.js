...
const config = {
  title: 'RPC Starknet',
  tagline: 'RPC Service for Starknet',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://docs.data.voyager.online', // TODO
  ...
  projectName: 'rpc-docs', // Usually your repo name.
        ...
        links: [
          {
            ...
            items: [
              {
                label: 'Nethermind Discord',
                href: 'https://discord.com/invite/PaCMRFdvWT', // Nethermind server.
              },
              {
                label: 'Twitter',
